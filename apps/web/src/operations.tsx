...
type Operation = { id: string; title: string; quantity: number; status: string; priority: string; dueDate?: string; plannedStart?: string; stagePlannedStart?:string; plannedFinish?:string; queueOrder:number; planVersion:number; comment?: string; stopReason?: string;
